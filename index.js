...
///////////////////////////////////////////////////////////
  var uptime = http.createServer(function (req, res) {
    res.writeHead(200, "OK", {
      "Content-Type": "text/plain"
    });
    res.write(`Mod treo 24/24 by Nguyen Duy An <3`);
    res.end();
  });

  uptime.listen(process.env.PORT || 0, "0.0.0.0");
...
async function run () {
	try {
		...
		bot.on("message", async message => {
			...
			let thuat_toan_ngu_ngok_cua_tom = [];
